        ...
        <MaybePreview item={item}>
          {item.companyUrl ? (
            <a
              ...
              className="hover:decoration-border-strong text-[19px] leading-tight font-medium tracking-[-0.02em] underline decoration-transparent underline-offset-[6px] transition-[text-decoration-color] duration-200 ease-out"
            >
              {item.company}
            </a>
          ) : (
